  ...
  return (
    <div className="min-h-svh bg-neutral-200 py-8 print:bg-white print:py-0">
      ...
      <article
        id="note-explication"
        lang="fr"
        className="mx-auto max-w-[210mm] bg-white px-5 py-10 text-[13px] sm:px-10 leading-relaxed text-neutral-900 shadow-lg print:max-w-none print:px-0 print:py-0 print:shadow-none"
      >
        {USE_MOCK && (
